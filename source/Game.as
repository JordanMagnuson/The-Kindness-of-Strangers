package source 
{
	...
	public class Game extends World
	{
		...
		[Embed(source='../assets/levels/MainLevel.oel', mimeType='application/octet-stream')] public var level1: Class;
		...
		{	
			...
			trace(Global.maze.x + ' ' + Global.maze.y);
			
			//add the view, and the player
			add(Global.player = new Player(xml.actors[0].player.@x * SCALE, xml.actors[0].player.@y * SCALE));
			...
			// Add the strangers
			for each (o in xml.actors[0].person_right) { add(new StrangerRight(o.@x * SCALE, o.@y * SCALE)); }		
			for each (o in xml.actors[0].person_left) { add(new StrangerLeft(o.@x * SCALE, o.@y * SCALE)); }	
			for each (o in xml.actors[0].person_up) { add(new StrangerUp(o.@x * SCALE, o.@y * SCALE)); }	
			for each (o in xml.actors[0].person_down) { add(new StrangerDown(o.@x * SCALE, o.@y * SCALE)); }	
		}
